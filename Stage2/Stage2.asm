...
MSG_LONG_MODE_PREP db "Preparing for Long Mode", 0
MSG_LONG_MODE_SUCCESS db "Long Mode Success, 64-bit Mode Initilized", 0
MSG_A20 db "A20 Set", 0
MSG_VIDEO_MODE_SET db "Video Mode Set", 0
